...
public class General extends JFrame {
	...
	public General() {
		...
		CajaTexto4.setIcon(new ImageIcon(General.class.getResource("/Imagenes/CajaTextoChico.png")));
		...
		CajaTexto2.setIcon(new ImageIcon(General.class.getResource("/Imagenes/CajaTextoChico.png")));
		...
		CajaTexto1.setIcon(new ImageIcon(General.class.getResource("/Imagenes/CajaTextoChico.png")));
		CajaTexto1.setBounds(345, 185, 220, 72);
		contentPane.add(CajaTexto1);

		JLabel logo = new JLabel("");
		logo.setBackground(Color.BLACK);
		logo.setIcon(new ImageIcon(General.class.getResource("/Imagenes/Logotop.jpg")));
		...
		CajaTexto3.setIcon(new ImageIcon(General.class.getResource("/Imagenes/CajaTextoChico.png")));
		CajaTexto3.setBounds(345, 360, 220, 72);
		contentPane.add(CajaTexto3);

		JLabel lbl_FondoTotal = new JLabel("New label");
		lbl_FondoTotal.setIcon(new ImageIcon(General.class.getResource("/Imagenes/marmolnegro.jpg")));
