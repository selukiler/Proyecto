...
public class Inicio extends JFrame {
	...
	public Inicio() {
		...
		CajaTexto4.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/CajaTextoChico.png")));
		...
		CajaTexto2.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/CajaTextoChico.png")));
		...
		CajaTexto1.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/CajaTextoChico.png")));
		...
		CajaTexto3.setIcon(new ImageIcon(Inicio.class.getResource("/Imagenes/CajaTextoChico.png")));
